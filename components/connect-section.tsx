    ...
    <section id="connect" className="py-24 px-6 lg:px-8" ref={sectionRef}>
      <div className="max-w-4xl mx-auto">
        <div className="text-center space-y-8">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-balance">Let's Talk Design</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
              I'm always open to discussing new product ideas, design systems, or opportunities to elevate your user experience.
            </p>
          </div>
          ...
          >
            <Button size="lg" className="gap-2" asChild>
              <a href="mailto:adivya9182@gmail.com">
          ...
          >
            <a
              href="https://www.behance.net/divya-uiux"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/divya-uiux"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 hover:bg-muted rounded-lg transition-colors"
              aria-label="LinkedIn"
